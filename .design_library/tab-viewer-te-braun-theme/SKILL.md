...
- 主色是 `#ff6f14`，高饱和橙色动作信号；保持 future-facing、restrained、precise，不要改成冷蓝或渐变主视觉。
- 基础中性色从 `#f7f2ea` 到 `#181818`；默认背景 `#f7f2ea`，前景 `#181818`，表面 `#fffdf8`，形成 warm-industrial 的暖白哑光与炭黑结构块。
...
- 深色模式把主色切到 `--tab-viewer-primary-400`，背景切到 `#181818`，表面 `#20201f`，保留橙色节奏与精密软件气质。
