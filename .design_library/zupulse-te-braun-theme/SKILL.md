...
- 主色是 `#f0492e`，TE 信号橙红动作信号；保持 future-facing、restrained、precise，不要改成冷蓝或渐变主视觉。
- 基础中性色从 `#e9e7e2` 到 `#181818`；默认背景 `#e9e7e2`，前景 `#181818`，表面 `#f0eee9`，形成 warm-industrial 的机身灰哑光与炭灰结构块。
...
- 深色模式把主色切到 `--zupulse-primary-400`，背景切到 `#1a1a1a`，表面 `#272727`，保留信号橙红节奏与精密软件气质。
