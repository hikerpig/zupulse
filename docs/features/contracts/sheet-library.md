...
| Modal 候选审阅、Library 格式筛选与 Browser dropped files  | [`ImportScoreDialog.tsx`](../../../packages/web-viewer/src/features/ImportScoreDialog.tsx)、[`importLibraryScores.ts`](../../../packages/web-core/src/library/importLibraryScores.ts)、[`BrowserScoreFileGateway.ts`](../../../apps/web-demo/src/library/BrowserScoreFileGateway.ts) | [`SheetLibrary.test.tsx`](../../../packages/web-viewer/src/features/__tests__/SheetLibrary.test.tsx)、[`importLibraryScores.test.ts`](../../../packages/web-core/src/library/__tests__/importLibraryScores.test.ts)、[`BrowserScoreFileGateway.test.ts`](../../../apps/web-demo/src/library/__tests__/BrowserScoreFileGateway.test.ts)、[`library.spec.ts`](../../../apps/web-demo/e2e/library.spec.ts) |
