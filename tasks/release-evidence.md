...
| 14  | 固定语料准确率、覆盖率、校准、性能达到门槛           | UCI Bach eval：Top-8 76.98%、precision 56.16%、coverage 100%、boundary F1 73.94%、ECE 1.17%；CMU CMA pop/keyboard eval：Top-8 45.90%、duration precision 16.35%、duration coverage 100%、boundary F1 97.21%、duration ECE 8.51%；`harmony:benchmark` 通过性能预算 | **未通过：准确率与 UCI boundary** |
