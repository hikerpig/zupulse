...
| 14  | 固定语料准确率、覆盖率、校准、性能达到门槛           | UCI Bach eval：Top-8 67.71%、precision 50.21%、coverage 100%、boundary F1 67.74%、ECE 1.79%；CMU CMA pop/keyboard eval：Top-8 11.98%、precision 3.63%、coverage 100%、boundary F1 91.68%、ECE 0.59%；`harmony:benchmark` 通过性能预算 | **未通过：准确率与 UCI boundary** |
