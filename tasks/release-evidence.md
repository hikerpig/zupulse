...
| 14  | 固定语料准确率、覆盖率、校准、性能达到门槛           | UCI Bach eval：Top-8 72.90%、precision 50.21%、coverage 100%、boundary F1 71.38%、ECE 1.75%；CMU CMA pop/keyboard eval：Top-8 40.11%、precision 10.09%、coverage 100%、boundary F1 95.38%、ECE 1.83%；`harmony:benchmark` 通过性能预算 | **未通过：准确率与 UCI boundary** |
