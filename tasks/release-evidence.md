...
| 14  | 固定语料准确率、覆盖率、校准、性能达到门槛           | UCI Bach eval：Top-8 76.98%、precision 54.12%、coverage 100%、boundary F1 71.84%、ECE 2.35%；CMU CMA pop/keyboard eval：Top-8 48.99%、precision 14.94%、coverage 100%、boundary F1 91.62%、ECE 1.44%；`harmony:benchmark` 通过性能预算 | **未通过：准确率与 UCI boundary** |
